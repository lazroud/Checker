#!/usr/bin/env bash
#
# flowxe-mtu-check.sh — End-to-end MTU validation for FLOWXE nodes
#
...
#
# Usage:
#   ./flowxe-mtu-check.sh              # interactive run, colored output
#   ./flowxe-mtu-check.sh --quiet      # minimal output (CI mode)
#   ./flowxe-mtu-check.sh --json       # JSON output for parsing
#   ./flowxe-mtu-check.sh --no-color   # plain text
#
# Exit codes:
